package com.equivi.channel.mailgun.response;
...
public class MailgunResponseItem implements Serializable {
     ...
     *
     * @param eventAPIType
     * @return true or false if this event type is equals EventAPIType(ACCEPTED,REJECTED,DELIVERED,etc) reference com.equivi.mailsy.service.com.equivi.channel.email.mailgun.response.EventAPIType
     */
