package com.equivi.channel.mailgun;

import com.equivi.channel.client.DemailerRestTemplate;
import com.equivi.channel.configuration.WebConfiguration;
import com.equivi.channel.configuration.dEmailerWebPropertyKey;
import com.equivi.channel.mailgun.response.MailgunResponseEventMessage;
import com.equivi.channel.mailgun.response.MailgunResponseMessage;
import com.equivi.channel.mailgun.response.UnsubscribeResponse;
import com.equivi.channel.mailgun.response.UnsubscribeResponseItems;
import com.equivi.channel.util.MailsyStringUtil;
...
public class MailgunRestTemplateEmailServiceImpl implements MailgunService {
    ...
    HttpEntity buildHttpEntity() {
        ...
        basicHttpEntity.setContentType(MediaType.APPLICATION_JSON_VALUE);
